...
function PermissionsContent() {
  ...
  const permissions = useAppSelector((s) => s.adminPermissions.current);
...
// 2. Wrap the child component with <Suspense>
  ...
  return (
    <AdminRoute>
      <div className="flex min-h-screen flex-col bg-[var(--bg-subtle)] text-[var(--text-main)]">
        ...
        <Suspense
          fallback={
            <div className="flex h-64 items-center justify-center text-sm font-medium text-[var(--text-muted)]">
              Loading permissions interface...
            </div>
          }
        >
          <PermissionsContent />
